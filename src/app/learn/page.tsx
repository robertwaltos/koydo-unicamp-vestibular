...
export const metadata: Metadata = {
  title: "Learn — UNICAMP Vestibular Practice",
  description: "Study and practice for UNICAMP Vestibular. Choose your subject and start preparing.",
};
