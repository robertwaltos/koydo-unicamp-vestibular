...
export const metadata: Metadata = {
  title: "Pricing — Unicamp Vestibular Premium",
  description: "Unlock unlimited Unicamp Vestibular practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=unicamp-vestibular&cadence=annual`;
