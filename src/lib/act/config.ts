// Auto-generated shim — re-exports from @/lib/unicamp-vestibular/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _unicamp_vestibular_Config } from "@/lib/unicamp-vestibular/config";
import { EXAM_CONFIG as _raw } from "@/lib/unicamp-vestibular/config";

// Normalise to the common shape expected by ecosystem components
export const EXAM_CONFIG = {
  ..._raw,
  examId: (_raw as { examId?: string }).examId ?? _raw.slug,
